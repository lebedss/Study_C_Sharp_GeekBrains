...
// Метод получает значение элемента по порядковому номеру в массиве (счёт по строчкам и первый элемент(верхний левый угол) имеет порядковый номер 0)
...
// Метод находит значение элемента по порядковому номеру в массиве (счёт по столбцам и первый элемент(верхний левый угол) имеет порядковый номер 1)
