...
{
    int sum = 0;
    //  Данное решение нерационально поскольку включает нулевой элемент массива и вообще проверяет каждый элемент:
    ...
    // Нас в любом массиве не волнует нулевой элемент потому что фактически ноль — чётное(Число называют чётным, если это число кратно 2) , не положительное и неотрицательное число
